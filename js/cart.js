        ...
        $.ajax({
            ...
            success: function (str) {
                ...
                var res = arr.data.map(function (item) {
                    // console.log(index);
                    return `<ul class="order_lists output" data-id="${item.zid}">
                                <li class="list_chk">
                                    <input type="checkbox" id="checkbox_${item.zid}" class="son_check">
                                    <label for="checkbox_${item.zid}"></label>
                                </li>
                                <li class="list_con">
                                    <div class="list_img"><a href="javascript:;"><img src="${item.bImg}" alt=""></a></div>
                                    <div class="list_text"><a href="javascript:;">${item.regName}</a></div>
                                </li>
                                <li class="list_info">
                                    <p>￥${item.price}</p>
                                </li>
                                ...
                                <li class="list_amount" style="padding-left:20px;">
                                ...
                                <li class="list_sum">
                                    <p class="sum_price">￥${item.price * item.num}</p>
                                </li>
                                <li class="list_op">
                                    <p class="del">
                ...
                $('.order_lists').on('click','.plus',function(){
                    ...
                    $.ajax({
                        ...
                        success : function(data){
                            ...
                            // $('#num').val(arr.data);
                            // let zhi = arr.quan[0].xianjia;
                            // $('.tatal-num').text(zhi*arr.data);
                            // all();
                ...
                // 删除宝贝
                $('.order_lists').on('click','.del',function(){
